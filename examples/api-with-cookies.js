import { ApiPoster } from "../classes/api-client.mjs";
import { CookieJar } from "tough-cookie";

// 1) Simple: set a cookie and send it automatically (Node)
const client = new ApiPoster({ url: "https://stealthapi.org/api" });
...
const A = new ApiPoster({ url: "https://stealthapi.org/a", cookieJar: jar });
const B = new ApiPoster({ url: "https://stealthapi.org/b" }).useCookieJar(jar);
